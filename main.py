...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("Tools AutoClaim DogecoinClickBot ".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("WhatsApp : +6282122261747")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Facebook : https://fb.me/sofyancrypto")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Created : INDONESIA CRYPTO TEAM (edited by @wahyu1605)(edit sikit by firlan)")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
